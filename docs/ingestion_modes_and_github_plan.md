...
3. [x] визначити розклад automatic incremental: понеділок 03:37
   `Europe/Kyiv`; retention початково зберігає всі production generations до
   вимірювання реального темпу приросту;
